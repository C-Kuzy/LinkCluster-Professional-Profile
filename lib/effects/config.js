...
export const breezeConfig = {
    ...
    streakCount: 3000,          // Number of wind streaks (higher = denser)
                                // Note: Auto-reduced to 50% on mobile, 75% on tablet for performance
    minStreakLength: 6,         // Minimum length of wind streaks (increased)
    ...
    areaHeight: 250,            // Vertical spread (increased)
    areaDepth: 400,             // Depth spread (increased)
